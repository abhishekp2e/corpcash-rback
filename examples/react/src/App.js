...
function NavMenu() {
  ...
  return _jsx("ul", {
    children: menu.map((item) =>
      _jsx("li", { children: item.label }, item.label)
    ),
  });
}
function Dashboard() {
  ...
  return _jsxs("div", {
    ...
    children: [
      _jsx("h1", { children: "Wallet Dashboard" }),
      _jsxs("p", { children: ["Admin role: ", isAdmin ? "yes" : "no"] }),
      _jsx("h2", { children: "Navigation" }),
      _jsx(NavMenu, {}),
      _jsx("h2", { children: "Actions" }),
      _jsx(Can, {
        resource: "wallet",
        action: "create",
        children: _jsx("button", { children: "Create Wallet" }),
      }),
      " ",
      _jsx(Can, {
        resource: "wallet",
        action: "delete",
        fallback: _jsx("span", { children: "No delete access" }),
        children: _jsx("button", { children: "Delete Wallet" }),
      }),
      " ",
      canCreateWallet && _jsx("span", { children: "(can create via hook)" }),
      canDeployContract && _jsx("button", { children: "Deploy Contract" }),
      _jsx(RequirePermission, {
        resource: "wallet",
        action: "read",
        fallback: _jsx("p", { children: "Access denied to wallet section." }),
        children: _jsxs("section", {
          children: [
            _jsx("h2", { children: "Wallet List" }),
            _jsx("p", { children: "You can view wallets." }),
          ],
        }),
      }),
    ],
